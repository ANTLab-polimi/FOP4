...
function mn_deps {
    ...
    pushd $MININET_DIR/P4-Containernet
    sudo make install
    popd
}
...
function of {
    ...
    patch -p1 < $MININET_DIR/P4-Containernet/util/openflow-patches/controller.patch
...
function install_wireshark {
    ...
    cp -n $MININET_DIR/P4-Containernet/util/colorfilters $HOME/.wireshark
...
function nox {
    ...
    git am $MININET_DIR/P4-Containernet/util/nox-patches/*tutorial-port-nox-destiny*.patch
    if [ "$DIST" = "Ubuntu" ] && version_ge $RELEASE 12.04; then
        git am $MININET_DIR/P4-Containernet/util/nox-patches/*nox-ubuntu12-hacks.patch
    fi
