...
d8 = net.addDocker('d8', dimage="containernet_example:lamp")
d9 = net.addDocker('d9', dimage="containernet_example:haproxy")
d10 = net.addDocker('d10', dimage="containernet_example:ubuntup4")
